...
cpus = [
  ...
  # 0.1,0.09,0.08,
  # 0.07,0.06,0.05,0.045,0.04,0.035,0.03,0.025,0.02,0.015,0.01,
  0.2, 0.15, 0.1,0.09,0.08,0.07,0.06,0.05,0.045,0.04,0.035,0.03,0.02,0.025,0.015
  ]
...
for cpu in cpus:
  x = pd.read_csv(f"./cmudb/experiments/read/replay_lag_{cpu}.txt", delimiter='|')
